...
(function ($) {
    ...
    var options = {
            ...
            errorMessages: {
                ...
                password_no_symbols: "The Password contains no symbols",
            ...
            validationRules: {
                ...
                wordUppercase: function (options, word, score) {
                    ...
                    if (!matches) {
                        options.errors.push(options.errorMessages.password_no_capital);
                    }
                ...
                wordOneSpecialChar : function (options, word, score) {
                     var matches = word.match(/.[!,@,#,$,%,\^,&,*,?,_,~]/);
                     if (!matches) {
                         options.errors.push(options.errorMessages.password_no_symbols);
                      }
                     return matches && score;
                },
        ...
        progressWidget = function () {
            return '<div class="progress" style="margin-bottom:0px;"><div class="bar"></div></div>';
        },
            ...
            init: function (settings) {
                ...
                return this.each(function (idx, el) {
                    ...
                    if (allOptions.showVerdicts) {
                        verdict = $('<span class="password-verdict" style="padding-left:10px;">' + allOptions.verdicts[0] + '</span>');
